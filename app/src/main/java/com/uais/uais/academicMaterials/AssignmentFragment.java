        ...
        if(isNetworkPresent) {
            ...
            client.post(UrlProvider.STUDENT_MODULES, params, new JsonHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                    ...
                    Log.d(getClass().getName()," statusCode: "+statusCode+" modules loaded at assignment");
                    ...
                    client.post(UrlProvider.STUDENT_ASSIGNMENT,params,new JsonHttpResponseHandler(){

                        @Override
                        public void onSuccess(int statusCode, Header[] headers, JSONArray response_) {
                            super.onSuccess(statusCode, headers, response_);
                            Log.d(getClass().getName()," statusCode: "+statusCode+" Assignment view");
