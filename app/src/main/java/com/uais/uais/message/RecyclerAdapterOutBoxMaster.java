...
public class RecyclerAdapterOutBoxMaster extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<DataConstructor> mItemList;
    Context context;

    public RecyclerAdapterOutBoxMaster(List<DataConstructor> itemList) {
        mItemList = itemList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(MasterFragmentOutBox.onClickListener);
