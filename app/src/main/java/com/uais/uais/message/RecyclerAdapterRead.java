...
public class RecyclerAdapterRead extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<DataConstructor> mItemList;
    Context context;
    public RecyclerItemViewHolder holder;
    public View view;

    public RecyclerAdapterRead(List<DataConstructor> itemList) {
        mItemList = itemList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(ChildFragmentReadMaster.onClickListener);
        view.setOnLongClickListener(ChildFragmentReadMaster.onLongClickListener);
