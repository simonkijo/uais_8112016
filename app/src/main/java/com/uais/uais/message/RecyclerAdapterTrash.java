...
public class RecyclerAdapterTrash extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<DataConstructor> mItemList;
    Context context;
    public RecyclerItemViewHolder holder;
    public View view;

    public RecyclerAdapterTrash(List<DataConstructor> itemList) {
        mItemList = itemList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnLongClickListener(ChildFragmentTrashMaster.onLongClickListener);
