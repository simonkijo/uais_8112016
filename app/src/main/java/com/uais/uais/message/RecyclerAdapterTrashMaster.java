...
public class RecyclerAdapterTrashMaster extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<DataConstructor> mItemList;
    Context context;

    public RecyclerAdapterTrashMaster(List<DataConstructor> itemList) {
        mItemList = itemList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(MasterFragmentTrash.onClickListener);
