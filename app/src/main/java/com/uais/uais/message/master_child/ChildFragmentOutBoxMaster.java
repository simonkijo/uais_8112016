...
import com.uais.uais.message.RecyclerAdapterOutBox;
...
public class ChildFragmentOutBoxMaster extends Fragment {
    private static final String SESSIONID = "ChildFragmentOutBoxMaster$session_id";
    private static final String TWONAMES = "ChildFragmentOutBoxMaster$twoNames";
    private static final String THREENAMES = "ChildFragmentOutBoxMaster$threeNames";

    private static final String CHROLE = "ChildFragmentOutBoxMaster$ch_role";
    private static final String CHIDNO = "ChildFragmentOutBoxMaster$ch_id_no";
    private static final String CHCS = "ChildFragmentOutBoxMaster$ch_cs";
    private static final String CHPG = "ChildFragmentOutBoxMaster$ch_pg";
    private static final String CHYR = "ChildFragmentOutBoxMaster$ch_yr";
    private static final String CHSM = "ChildFragmentOutBoxMaster$ch_sm";
    private static final String REPLY = "ChildFragmentOutBoxMaster$reply";
    private static final String SENDER = "ChildFragmentOutBoxMaster$sender";
    private static final String SUBJECT = "ChildFragmentOutBoxMaster$subject";
    private static final String FROM = "ChildFragmentOutBoxMaster$from";
    private static final String DATE = "ChildFragmentOutBoxMaster$date";
    private static final String TIME = "ChildFragmentOutBoxMaster$time";
    private static final String SMS = "ChildFragmentOutBoxMaster$sms";
    private static final String SMS_ID = "ChildFragmentOutBoxMaster$smsId";
    ...
    Bundle bi;
    RecyclerAdapterOutBox recyclerAdapter;
    ...
    public static ChildFragmentOutBoxMaster getAllDataOutBox(
        ...
        ChildFragmentOutBoxMaster cfom = new ChildFragmentOutBoxMaster();
        cfom.setArguments(bundle);
        return cfom;
    }
    @Override
    ...
    private void setupRecyclerView(RecyclerView recyclerView, boolean isCheck, boolean isVisible) {
        ...
        recyclerAdapter = new RecyclerAdapterOutBox(createItemList(isCheck,isVisible));
