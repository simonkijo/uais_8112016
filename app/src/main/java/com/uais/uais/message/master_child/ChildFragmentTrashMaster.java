...
import com.uais.uais.message.RecyclerAdapterTrash;
...
public class ChildFragmentTrashMaster extends Fragment {
    private static final String SESSIONID = "ChildFragmentTrashMaster$session_id";
    private static final String TWONAMES = "ChildFragmentTrashMaster$twoNames";
    private static final String THREENAMES = "ChildFragmentTrashMaster$threeNames";

    private static final String CHROLE = "ChildFragmentTrashMaster$ch_role";
    private static final String CHIDNO = "ChildFragmentTrashMaster$ch_id_no";
    private static final String CHCS = "ChildFragmentTrashMaster$ch_cs";
    private static final String CHPG = "ChildFragmentTrashMaster$ch_pg";
    private static final String CHYR = "ChildFragmentTrashMaster$ch_yr";
    private static final String CHSM = "ChildFragmentTrashMaster$ch_sm";
    private static final String REPLY = "ChildFragmentTrashMaster$reply";
    private static final String SENDER = "ChildFragmentTrashMaster$sender";
    private static final String SUBJECT = "ChildFragmentTrashMaster$subject";
    private static final String FROM = "ChildFragmentTrashMaster$from";
    private static final String DATE = "ChildFragmentTrashMaster$date";
    private static final String TIME = "ChildFragmentTrashMaster$time";
    private static final String SMS = "ChildFragmentTrashMaster$sms";
    private static final String SMS_ID = "ChildFragmentTrashMaster$smsId";
    ...
    Bundle bi;
    RecyclerAdapterTrash recyclerAdapter;
    ...
    public static ChildFragmentTrashMaster getAllDataTrash(
        ...
        ChildFragmentTrashMaster cftm = new ChildFragmentTrashMaster();
        cftm.setArguments(bundle);
        return cftm;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.i("MNDrawer Master-Child", "Master filtered trash created");
    ...
    private void setupRecyclerView(RecyclerView recyclerView, boolean isCheck, boolean isVisible) {
        ...
        recyclerAdapter = new RecyclerAdapterTrash(createItemList(isCheck,isVisible));
    ...
    public class MyOnLongClickListener implements View.OnLongClickListener{
        ...
        public boolean onLongClick(View v) {
            ...
            if(bi.getCharSequenceArrayList(SENDER).size() == 0){
                ...
                menu.findItem(R.id.action_delete).setIcon(R.mipmap.ic_undo_white_24dp).setTitle("Undo"); //set icon undo and title
                ...
                mi_delete.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {  //register click listener
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.action_delete) {
                            ...
                            //call for setting data to untrash in server online
                            s.setUnTrash(smsToBeDeleted, bi.getString(SESSIONID));
