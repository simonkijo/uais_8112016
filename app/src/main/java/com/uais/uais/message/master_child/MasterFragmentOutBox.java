...
import com.uais.uais.message.RecyclerAdapterOutBoxMaster;
...
public class MasterFragmentOutBox extends Fragment {
    private static final String SESSIONID = "MasterFragmentOutBox$session_id";
    private static final String TWONAMES = "MasterFragmentOutBox$twoNames";
    private static final String THREENAMES = "MasterFragmentOutBox$threeNames";
    ...
    Bundle bi;
    RecyclerAdapterOutBoxMaster recyclerAdapter;


    public static MasterFragmentOutBox getSessionId(String sessionId,String twoNames,String threeNames){
        Bundle bundle = new Bundle();
        bundle.putString(SESSIONID,sessionId);
        bundle.putString(TWONAMES,twoNames);
        bundle.putString(THREENAMES,threeNames);
        MasterFragmentOutBox mfr = new MasterFragmentOutBox();
    ...
    private void setupRecyclerView(RecyclerView recyclerView,ArrayList<String> sender) {
        ...
        recyclerAdapter = new RecyclerAdapterOutBoxMaster(createItemList(sender));
    ...
    public class MyOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(sender.size() == 0){
                ...
                ((MaterialNavigationDrawer) act_).setFragmentChild(ChildFragmentOutBoxMaster.getAllDataOutBox(
            ...
            client.post(UrlProvider.LOAD_ROLE, params, new JsonHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                    ...
                    if (isAdded() && getActivity() != null) {  //this isAdded() removes IllegalStateException if user interrupt background process
                        ...
                        client.post(UrlProvider.LOAD_OUTBOX, params, new JsonHttpResponseHandler() {
                            @Override
