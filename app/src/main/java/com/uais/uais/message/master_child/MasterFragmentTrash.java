...
import com.uais.uais.message.RecyclerAdapterTrashMaster;
...
public class MasterFragmentTrash extends Fragment {
    private static final String SESSIONID = "MasterFragmentTrash$session_id";
    private static final String TWONAMES = "MasterFragmentTrash$twoNames";
    private static final String THREENAMES = "MasterFragmentTrash$threeNames";
    ...
    Bundle bi;
    RecyclerAdapterTrashMaster recyclerAdapter;

    public static MasterFragmentTrash getSessionId(String sessionId,String twoNames,String threeNames){
        Bundle bundle = new Bundle();
        bundle.putString(SESSIONID,sessionId);
        bundle.putString(TWONAMES,twoNames);
        bundle.putString(THREENAMES,threeNames);
        MasterFragmentTrash mfr = new MasterFragmentTrash();
    ...
    private void setupRecyclerView(RecyclerView recyclerView, ArrayList<String> sender) {
        ...
        recyclerAdapter = new RecyclerAdapterTrashMaster(createItemList(sender));
    ...
    public class MyOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(sender.size() == 0){
                ...
                ((MaterialNavigationDrawer) act_).setFragmentChild(ChildFragmentTrashMaster.getAllDataTrash(
            ...
            client.post(UrlProvider.LOAD_ROLE, params, new JsonHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                    ...
                    if (isAdded() && getActivity() != null) {  //this isAdded() removes IllegalStateException if user interrupt background process
                        ...
                        client.post(UrlProvider.LOAD_TRASH, params, new JsonHttpResponseHandler() {
                            @Override
