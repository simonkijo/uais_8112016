package it.neokree.materialnavdrawer.elements;
...
public class MaterialAccount {
    ...
    public MaterialAccount(Resources resources,String title, String subTitle, String photoUrl,int background) {
        this.title = title;
    ...
    public String getServerUrl(){return uri;}
